    ...
    <main className="flex flex-col items-center">
      ...
      <Accordion defaultIndex={[0]} allowToggle>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            Stekcit BM, stylized as “Stek•cit BM is a mobile-first, online
        ...
        <AccordionItem>
          <Heading>
            <AccordionButton>
              <Box as="span" flex="1" textAlign="left">
                How can I earn from Stekcit BM?
              </Box>
              <AccordionIcon />
            </AccordionButton>
          </Heading>
          ...
          <AccordionPanel pb={4}>
            ...
            event and set a ticket price (say 2 USDC), and promote it within
        ...
        <AccordionItem>
          <Heading>
            <AccordionButton>
              <Box as="span" flex="1" textAlign="left">
                How much can I make from Stekcit BM?
              </Box>
              <AccordionIcon />
            </AccordionButton>
          </Heading>
          ...
          <AccordionPanel pb={4}>
            ...
            earnings go to the owner of Stekcit BM takes 20%. That is way
        ...
        <AccordionItem>
          <Heading>
            <AccordionButton>
              <Box as="span" flex="1" textAlign="left">
                What type of events are best for Stekcit BM?
              </Box>
              <AccordionIcon />
            </AccordionButton>
          </Heading>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            Stekcit BM runs on top of the Celo blockchain, a L1, EVM-based
